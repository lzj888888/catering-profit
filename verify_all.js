...
//       + 菜品分类「自由定义」守卫（tools/check_dish_category_free.js，R148：李老师反馈 2026-09-26 ——
//         分类按热菜/凉菜分，但火锅要分荤菜/素菜、还有「大口吃肉」这类营销栏目名。查证：
//         v1.0 规范 §菜品分类 明写「支持自定义」，而 edit.wxml 实现是 picker（**只能选 7 个预设**）
