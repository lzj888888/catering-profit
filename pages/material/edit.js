...
Page({
  data: {
    t: {
      ...
      matConvertHint: TERMS.card.matConvertHint,
      ...
      if (this.data.isEdit) {
        ...
        if (m) {
          ...
          this.setData({
            ...
            convert_factor: String(m.convert_factor || 500),
  ...
  onUnit(e) { this.setData({ purchase_unit: e.detail.value }); },
  onPrice(e) { this.setData({ priceYuan: e.detail.value }); },
  onConvert(e) { this.setData({ convert_factor: e.detail.value }); },
  ...
  async onSave() {
    ...
    const material = {
      ...
      purchase_unit: this.data.purchase_unit || TERMS.card.matUnitDefault,
      purchase_price_fen: purchasePriceFen,
      convert_factor: Number(this.data.convert_factor) || 500,
