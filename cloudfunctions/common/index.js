...
module.exports = {
  ...
  isDuplicateKeyError: require('./errors').isDuplicateKeyError,
  ...
  //    伴侣守卫：tools/check_requires.js §2「common 解构符号导出完整性」。
  defaultShopId: require('./auth').defaultShopId,
  defaultEntitlementId: require('./auth').defaultEntitlementId,
  ...
  specDerive: require('./specDerive'),
  LINE_KINDS: require('./specDerive').LINE_KINDS,
  SPEC_PRESETS: require('./specDerive').SPEC_PRESETS,
  deriveSpec: require('./specDerive').deriveSpec,
  kindOf: require('./specDerive').kindOf,
